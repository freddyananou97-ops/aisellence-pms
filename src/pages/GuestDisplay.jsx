...
function SignatureCanvas({ onSign, label = 'Unterschrift' }) {
  ...
  return (
    <div>
      ...
      {hasDrawn && <button onClick={clear} style={{ marginTop: 8, padding: '6px 16px', background: '#f3f4f6', border: '1px solid #e5e7eb', borderRadius: 8, fontSize: 13, color: '#6b7280', cursor: 'pointer', fontFamily: 'inherit' }}>{label === 'Sign here' ? 'Clear signature' : 'Unterschrift löschen'}</button>}
    </div>
  )
}
