...
const s = {
  ...
  entryMsg: { fontSize: 13, color: 'var(--textSec, #bbb)', lineHeight: 1.5, margin: '0 0 10px' },
  ...
  formPanel: { width: '100%', maxWidth: 480, background: 'var(--modalBg, var(--bg-secondary))', border: '1px solid var(--modalBorder, var(--border))', borderRadius: 16, padding: '24px', maxHeight: '90vh', overflow: 'auto' },
  closeBtn: { background: 'var(--bgCard, var(--bg-card))', border: 'none', borderRadius: 6, width: 28, height: 28, fontSize: 14, cursor: 'pointer', color: 'var(--textMuted, var(--text-muted))' },
  label: { display: 'block', fontSize: 10, fontWeight: 500, color: 'var(--textMuted, var(--text-muted))', marginBottom: 6, textTransform: 'uppercase', letterSpacing: 0.5 },
  input: { width: '100%', padding: '10px 14px', background: 'var(--inputBg, var(--bg-primary))', border: '1px solid var(--borderLight, var(--border-light))', borderRadius: 8, fontSize: 13, color: 'var(--text, #fff)', outline: 'none', boxSizing: 'border-box', marginBottom: 16, fontFamily: 'inherit' },
  saveBtn: { width: '100%', padding: 12, background: 'var(--text, #fff)', color: 'var(--bg, #080808)', border: 'none', borderRadius: 8, fontSize: 13, fontWeight: 600, cursor: 'pointer', marginTop: 4 },
}
